...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable()
                ...
                .requestMatchers("/api/v1/configservice/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/configservice/configs").hasAnyRole(admin)
                .requestMatchers(HttpMethod.PUT, "/api/v1/configservice/configs").hasAnyRole(admin)
                .requestMatchers(HttpMethod.DELETE, "/api/v1/configservice/configs/*").hasAnyRole(admin)
