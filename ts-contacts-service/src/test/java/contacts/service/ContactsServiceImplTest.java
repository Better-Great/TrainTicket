...
public class ContactsServiceImplTest {
    ...
    public void testFindContactsById1() {
        ...
        Mockito.when(contactsRepository.findById(Mockito.anyString())).thenReturn(Optional.of(contacts));
    ...
    public void testFindContactsById2() {
        UUID id = UUID.randomUUID();
        Mockito.when(contactsRepository.findById(Mockito.anyString())).thenReturn(Optional.empty());
        Response result = contactsServiceImpl.findContactsById(id.toString(), headers);
    ...
    public void testFindContactsByAccountId() {
        ...
        Mockito.when(contactsRepository.findByAccountId(Mockito.anyString())).thenReturn(arr);
    ...
    public void testCreateContacts1() {
        Contacts contacts = new Contacts();
        contacts.setAccountId("account-id");
        contacts.setDocumentNumber("doc-number");
        contacts.setDocumentType(1);
        Contacts existingContacts = new Contacts();
        existingContacts.setId("existing-id");
        Mockito.when(contactsRepository.findByAccountIdAndDocumentTypeAndDocumentType(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt())).thenReturn(existingContacts);
        Response result = contactsServiceImpl.createContacts(contacts, headers);
        Assert.assertEquals(new Response<>(0, "Already Exists", existingContacts), result);
    }

    @Test
    public void testCreateContacts2() {
        Contacts contacts = new Contacts();
        Mockito.when(contactsRepository.findByAccountIdAndDocumentTypeAndDocumentType(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt())).thenReturn(null);
    ...
    public void testCreate1() {
        ...
        Mockito.when(contactsRepository.findByAccountIdAndDocumentTypeAndDocumentType(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt())).thenReturn(addContacts);
    ...
    public void testCreate2() {
        Contacts addContacts = new Contacts(UUID.randomUUID().toString(), UUID.randomUUID().toString(), "name", 1, "12", "10001");
        Mockito.when(contactsRepository.findByAccountIdAndDocumentTypeAndDocumentType(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt())).thenReturn(null);
        Mockito.when(contactsRepository.save(Mockito.any(Contacts.class))).thenReturn(addContacts);
        Response result = contactsServiceImpl.create(addContacts, headers);
    ...
    public void testDelete1() {
        ...
        Mockito.doNothing().when(contactsRepository).deleteById(Mockito.anyString());
        Mockito.when(contactsRepository.findById(Mockito.anyString())).thenReturn(Optional.empty());
