...
public class SecurityConfig {
    ...
    String admin = "ADMIN";
    String waitOrder = "/api/v1/waitorderservice/**";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable()
                ...
                .requestMatchers("/api/v1/waitorderservice/welcome").permitAll()
                .requestMatchers(HttpMethod.GET, waitOrder).permitAll()
                .requestMatchers(HttpMethod.POST, waitOrder).hasAnyRole(admin, "USER")
                .requestMatchers(HttpMethod.PUT, waitOrder).hasAnyRole(admin, "USER")
                .requestMatchers(HttpMethod.DELETE, waitOrder).hasAnyRole(admin, "USER")
